...
<body>
    ...
    <form method="POST">
        ...
        <input type="number" name="telefono" id="telefono"  pattern="[0-9]{4}" >
    ...
    <?php
    switch (true) {
        case isset($_POST['Guardar']) && !empty($_POST['nombre'] && !empty($_POST['telefono'])):
            $persona = new Persona($_POST['nombre'],$_POST['telefono']);
            $_SESSION['agenda'][] = $persona;
            echo "<p>Persona guardad en la agenda</p>";
            break;
        ...
        case isset($_POST['Leer']) :
            ...
            foreach ($_SESSION['agenda'] as $persona) {
                $output= "<p>Nombre: ". $persona->getNombre()." Telefono: ".$persona->getTelefono()."</p>";
                echo $output;
            }
        }
            break;
